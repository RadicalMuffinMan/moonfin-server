...
const Plugin = {
  ...
  addUserPreferencesLink() {
    ...
    link.innerHTML = '<div class="listItem" style="cursor:pointer">' + '<span class="material-icons listItemIcon listItemIcon-transparent settings" aria-hidden="true"></span>' + '<div class="listItemBody">' + '<div class="listItemBodyText">Moonfin</div>' + '</div>' + '</div>';
